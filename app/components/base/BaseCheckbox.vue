...
import { baseCheckboxProps, useBaseCheckbox } from '../../composable/base/base-checkbox.composable.js'
...
.base-checkbox {
  ...
  &--label-right  { flex-direction: row; align-items: center; }
  &--label-left   { flex-direction: row-reverse; align-items: center; }
  &--label-bottom { flex-direction: column; }
  &--label-top    { flex-direction: column-reverse; }
