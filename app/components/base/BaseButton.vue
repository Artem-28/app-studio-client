...
import { baseRouterLinkProps, useBaseRouterLink } from '../../composable/base/base-router-link.composable.js'
...
const { tag, linkAttrs, navigateOnClick } = useBaseRouterLink(props, emit, { fallbackTag: 'button' })
...
.base-btn {
  ...
  &:not(.base-btn--disable):hover {
    ...
    // TODO: заменить на актуальные глобальные классы после их определения
    .base-btn__bg.opacity--0  { opacity: 0.2; }
    .base-btn__bg.opacity--10 { opacity: 0.3; }
    .base-btn__bg.opacity--20 { opacity: 0.4; }
    .base-btn__bg.opacity--30 { opacity: 0.5; }
    .base-btn__bg.opacity--40 { opacity: 0.6; }
    .base-btn__bg.opacity--50 { opacity: 0.7; }
    .base-btn__bg.opacity--60 { opacity: 0.8; }
    .base-btn__bg.opacity--70 { opacity: 0.9; }
    .base-btn__bg.opacity--80 { opacity: 1; }
    .base-btn__bg.opacity--90::before  { opacity: 0.1; background-color: white; }
    .base-btn__bg.opacity--100::before { opacity: 0.2; background-color: white; }
  }
