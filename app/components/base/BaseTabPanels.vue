...
watch(() => props.modelValue, (newVal, oldVal) => {
  ...
  setTimeout(() => emit('transition', newVal, oldVal), parseInt(String(props.transitionDuration)))
})
...
.slide-right-leave-active {
  transition: transform v-bind('`${parseInt(String(transitionDuration))}ms`') ease,
